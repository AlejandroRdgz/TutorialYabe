...
public class Application extends Controller {
    ...
    public static void postComment(Long postId,
        ...
        validation.equals(
                code, play.cache.Cache.get(randomID)).
        ...
        if (!Play.id.equals("test")) {
            validation.equals(code, play.cache.Cache.get(randomID)).message("Invalid code. Please type it again");
        }
        post.addComment(author, content);
        flash.success("Thanks for posting %s", author);
        play.cache.Cache.delete(randomID);
        show(postId);
    }
